...
namespace Afterglow.Core
{
    public class PixelReader: IDisposable
    {
        ...
        public PixelReader(FastBitmap fastBitmap): this(fastBitmap, new Rectangle(0, 0, fastBitmap.Bitmap.Width, fastBitmap.Bitmap.Height))
        {
            
        }

        private readonly bool _ownsFastBitmap;
        public PixelReader(Bitmap bitmap): this(new FastBitmap(bitmap))
        {
