...
namespace Afterglow.DirectX
{
    ...
    /// <summary>
    /// Direct3D 10_1 Hook - this hooks the SwapChain.Present method to capture images
    /// </summary>
    internal class DXHookD3D10_1: BaseDXHook
    {
        ...
        {
            font.Draw(null, text, new System.Drawing.Rectangle((int)pos.X, (int)pos.Y, 0, 0), FontDrawFlags.NoClip, color);
        }
    }
}
