...
namespace Afterglow.DirectX
{
    ...
    internal class DXHookD3D10: BaseDXHook
    {
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Unicode, SetLastError = true)]
        delegate int DXGISwapChain_ResizeTargetDelegate(IntPtr swapChainPtr, ref SlimDX.DXGI.ModeDescription newTargetParameters);
        ...
        /// <returns></returns>
        int ResizeTargetHook(IntPtr swapChainPtr, ref SlimDX.DXGI.ModeDescription newTargetParameters)
        {
